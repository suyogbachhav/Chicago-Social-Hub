...
@Component({
  selector: 'app-real-time-divvy-heat-map',
  templateUrl: './real-time-divvy-heat-map.component.html',
  styleUrls: ['./real-time-divvy-heat-map.component.css']
})
export class RealTimeDivvyHeatMapComponent implements OnInit {
  ...
  // The following are tunable parameters that are used to display n samples
    ...
    MORNING_SESSION =  '8am-9am';
    EVENING_SESSION =  '5pm-6pm';

    // PAST_HOUR =  '8am-9am';
    // PAST_24_HOURS =  '5pm-6pm';
    

    newTimeRangeSelection = true;
    notNewTimeRangeSelection = false;
    placeSelected: Place;
    timeRangeSelected = this.MORNING_SESSION;
    ...
    timeValues = [
      { id : this.MORNING_SESSION, value: this.MORNING_SESSION},
      { id : this.EVENING_SESSION, value: this.EVENING_SESSION}
  ...
  icon = {
    ...
    ngOnInit() {
      // this.timeRangeSelected = this.MORNING_SESSION;
...
//////////////////////////////////////////////////////////////////////////////
  ...
  getDivvyStationsStatus(timeRangeSelection){
    ...
    if (this.timeRangeSelected == this.MORNING_SESSION){
    ...
    else if (this.timeRangeSelected == this.EVENING_SESSION){
    ...
    //          timeRangeSelected == this.EVENING_SESSION
      ...
      this.placesService.get_all_divvy_stations_data(this.timeRangeSelected, timeRangeSelection).subscribe((data: Station[]) => {
        ...
        if (this.timeRangeSelected == this.MORNING_SESSION){
          this.timeOffset = (this.noOfDivvyDataSamplesProcessed) * (60 * 1000 * 2);
                ...
                if (this.timeRangeSelected == this.EVENING_SESSION){
