...
import { RealTimeDivvyHeatMapComponent } from './components/real-time-divvy-heat-map/real-time-divvy-heat-map.component';
...
const routes: Routes = [
  ...
  {path: 'realtime_heat_map', component: RealTimeDivvyHeatMapComponent}
];
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    AgmCoreModule.forRoot({apiKey: 'AIzaSyANho3VyRDhrNN62QJqNJrQUXyHoTqoBN4'+ '&libraries=visualization'}),
    FormsModule,
    NgbModule,
    MatCheckboxModule
